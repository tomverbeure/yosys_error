...
module VexRiscv (
  ...
  always @ (posedge clk) begin
    if(_zz_VexRiscv_255_) begin
      _zz_VexRiscv_154_ <= RegFilePlugin_regFile[decode_RegFilePlugin_regFileReadAddress1];
    end
  end

  always @ (posedge clk) begin
    if(_zz_VexRiscv_256_) begin
      _zz_VexRiscv_155_ <= RegFilePlugin_regFile[decode_RegFilePlugin_regFileReadAddress2];
    end
  end
